...
| --- | --- | --- | --- |
| Jean-Luc Picard | Product & Architecture Lead | review, advisory | product strategy, architecture decisions, cost/portability tradeoffs |
...
| Geordi La Forge | Full-Stack & Platform Engineer | edit | modern web platforms, cloud architecture, CI/CD and integrations |
| Seven of Nine | Identity, Data & AI Engineer | edit | authentication/authorization, data governance, OAuth connectors and RAG |
| Miles O'Brien | Quality & Reliability Engineer | review, edit | threat modeling, test strategy, accessibility/performance and operations |
| Sarek | Legal, Regulatory & Corporate Advisor | review, advisory | official-source legal research, compliance issue spotting, IP and contracts |
| Rai | Responsible AI & Social Impact Reviewer | review | RAI review, content safety, bias detection, credential scanning, ethical pattern review. |
...
Product & Architecture Lead, Experience & Design Lead, Content, Multimedia & Social Lead, Full-Stack & Platform Engineer, Identity, Data & AI Engineer, Quality & Reliability Engineer, Legal, Regulatory & Corporate Advisor, Responsible AI & Social Impact Reviewer, Verification & Devil's Advocate
...
- **Can:** review code and pull requests; write and modify code; write and run tests; security and secrets review; responsible-AI and content-safety review; cut releases and publish packages; author and maintain CI/CD workflows; UX and visual design; deploy to live environments
- **Cannot (no agent claims this):** write and maintain documentation
