...
| `docs/content/homepage-copy-draft.md` | Nyota Uhura | — | Fact Checker, Sarek, Rai, Dax; Cyrus | #43; parent #39 | Draft; no section approved for publication; all candidate wording review-gated | [Content](README.md#child-research) |
...
| `docs/content/public-claims-register.md` | Nyota Uhura; integrated by Picard | Jadzia Dax | Sarek, Rai, Fact Checker; Cyrus | #4; claim evidence; updated #43 | C2 + #43 homepage candidates added; no public claim approved | [Registers](README.md#shared-registers) |
